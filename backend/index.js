...
// app.post('/addreminder', (req, res) =>{
//   const reminderMsg=req.body.reminderMsg
//   const remindAt=req.body.remindAt
//   db.query('INSERT INTO mydb {task,remindtime} VALUES{?,?}' 
//   [reminderMsg ,remindAt], (err,result) =>{
//     if(err)
//     {
//       console.log("Something went wrong not inserted")
//     }
//     else
//     {
...
// })
// app.listen(3010, () => {
//   console.log("Hey man your port is running");
// });